        ...
        <div className="bg-white dark:bg-gray-950">
            ...
            <header className="absolute inset-x-0 top-0 z-50">
                <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
                    <div className="flex">
                        <a href={getMainSiteUrl()} className="-m-1.5 p-1.5">
                        ...
                        <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-amber-900/60 via-gray-900 to-indigo-900/60 ring-1 ring-white/10">
                            <div className="grid grid-cols-1 lg:grid-cols-2">
                                ...
                                <div className="flex flex-col justify-center px-8 py-14 lg:px-14">
                                    ...
                                    <h2 className="mt-6 text-4xl font-bold tracking-tight text-white sm:text-5xl">Noteleks</h2>
                                    ...
                                    <p className="mt-5 text-base leading-relaxed text-gray-300">
                                        A 2D action platformer built with Phaser 3 and Laravel. Control a skeleton warrior, fight waves of enemies,
                                        and survive as long as you can. Runs entirely in the browser — no download, no install.
                                    </p>
                                    <ul className="mt-6 space-y-2 text-sm text-gray-400">
                                        <li className="flex items-center gap-2">
                                            <span className="text-amber-400">✦</span> Spine 2D skeletal animation
                                        </li>
                                        <li className="flex items-center gap-2">
                                            <span className="text-amber-400">✦</span> Physics-based combat with projectile weapons
                                        </li>
                                        <li className="flex items-center gap-2">
                                            <span className="text-amber-400">✦</span> Mobile touch controls
                                        </li>
                                        <li className="flex items-center gap-2">
                                            <span className="text-amber-400">✦</span> Enemy AI with round-based spawning
                                        </li>
                                    </ul>
                                    <div className="mt-10 flex flex-wrap gap-4">
                                        <a
                                            ...
                                            className="inline-flex items-center gap-2 rounded-full bg-amber-500 px-6 py-3 text-sm font-semibold text-gray-900 shadow-lg transition-colors hover:bg-amber-400"
                                        >
                                            🎮 Play Now
                                        </a>
                                        <a
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="mt-6 flex justify-center gap-2">
                                            {['⚔️', '🏹', '🗡️', '🔥'].map((icon, i) => (
                                                <span
                                                    key={i}
                                                    className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 text-lg ring-1 ring-white/10"
                                                >
                                                    {icon}
                                                </span>
                                            ))}
