...
- **SSR Server**: http://localhost:13716
...
|---------|------|---------|
| Laravel | 8003 | Main application server |
| Vite | 5175 | Development build server with HMR |
| SSR | 13716 | Inertia.js server-side rendering |
...
INERTIA_SSR_URL=http://127.0.0.1:13716
```
...
3. Ensure database exists: `CREATE DATABASE studio;`
4. Run migrations: `php artisan migrate`

### SSR Not Working

1. Verify `.env` has `INERTIA_SSR_ENABLED=true`
2. Check SSR server is running on port 13716
