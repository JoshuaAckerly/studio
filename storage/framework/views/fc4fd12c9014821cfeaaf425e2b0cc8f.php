...
<head>
    ...
    <title>Noteleks Heroes Beyond Light - <?php echo e(config('app.name')); ?></title>
    ...
    <script>
        ...
        (function(){
            var debug = <?php echo e(config('app.debug') ? 'true' : 'false'); ?>;
    ...
    <script>
        ...
        var trackingId = '<?php echo e(config('services.google_analytics.tracking_id')); ?>';
    ...
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/games/noteleks/main-modular.js'); ?>
    <style>
        * {
            margin: 0;
            padding: 0;
...
</html><?php /**PATH C:\Users\acker\Herd\studio\resources\views/games/noteleks.blade.php ENDPATH**/ ?>