...
<p>Graveyard Jokes Studios — the agency side of this portfolio — is now live on DesignRush, a premier agency directory used by businesses to vet and hire web agencies. The listing covers the full service range: web design and development, eCommerce builds, SEO, digital marketing, and ongoing maintenance. Rate is $75/hr with a $2,500 minimum budget, which keeps it accessible to the small businesses and creatives the agency is built for. All five portfolio clients are listed — Hollow Press, Lunar Blood, The Velvet Pulse, Velvet Radio, and Synth Veil — which adds social proof and backlink authority at the same time. This is a meaningful step toward building a credible, searchable business identity rather than just a collection of projects.</p>
